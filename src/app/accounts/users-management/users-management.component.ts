...
import { IUserRoleObj, userRoleObj } from 'src/app/shared/params/admin/userRolesModal';
...
export class UsersManagementComponent implements OnInit{
  ...
  openRolesModal(user: IUser) {
    ...
    this.bsModalRef.content.updateSelectedRoles.subscribe((values: IUserRoleObj[]) => {
      const rolesToUpdate = {
