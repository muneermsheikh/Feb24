...
import { DlForwardService } from 'src/app/shared/services/admin/dl-forward.service';
import { OrderService } from 'src/app/shared/services/admin/order.service';
import { OrderitemsService } from 'src/app/shared/services/admin/orderitems.service';
import { ReviewService } from 'src/app/shared/services/admin/review.service';
...
import { ChooseAgentsModalComponent } from 'src/app/shared/components/modal/choose-agents-modal/choose-agents-modal.component';
...
export class OrderEditComponent implements OnInit{
  ...
  constructor(private service: OrderService, 
    ...
    setExistingItems(items: IOrderItem[]) {
