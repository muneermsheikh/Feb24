...
import { SelectionService } from 'src/app/shared/services/hr/selection.service';
...
export class SelectionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.data.subscribe(
      data => { 
      this.selectionsPending = data['selectionsPending'];
      this.selectionStatus = data['selectionStatus'];
      this.totalCount = data['selectinsPending'].count;
