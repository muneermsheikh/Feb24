...
@Component({
  selector: 'app-employmt-modal',
  templateUrl: './employmt-modal.component.html',
  styleUrls: ['./employmt-modal.component.scss']
})
export class EmploymtModalComponent implements OnInit {
