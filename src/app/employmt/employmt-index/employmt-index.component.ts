...
@Component({
  selector: 'app-employmt-index',
  templateUrl: './employmt-index.component.html',
  styleUrls: ['./employmt-index.component.scss']
})
export class EmploymtIndexComponent implements OnInit{
