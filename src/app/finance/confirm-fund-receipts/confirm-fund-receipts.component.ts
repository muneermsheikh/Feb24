...
import { ConfirmReceiptsService } from 'src/app/shared/services/finance/confirm-receipts.service';
import { MessageService } from 'src/app/shared/services/message.service';

@Component({
  selector: 'app-confirm-fund-receipts',
  templateUrl: './confirm-fund-receipts.component.html',
  styleUrls: ['./confirm-fund-receipts.component.scss']
})
export class ConfirmFundReceiptsComponent implements OnInit{
  ...
  setExistingPending(ps: IPendingDebitApprovalDto[]) {
    
    ps.forEach(p => {
      this.pending.push(this.fb.group({
