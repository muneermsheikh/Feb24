...
import { assessmentQBankParams } from 'src/app/shared/models/admin/assessmentQBankParams';
import { IUser } from 'src/app/shared/models/admin/user';
import { IProfession } from 'src/app/shared/models/masters/profession';
import { QbankService } from 'src/app/shared/services/hr/qbank.service';
import { BreadcrumbService } from 'xng-breadcrumb';

@Component({
  selector: 'app-assess-qbank',
  templateUrl: './assess-qbank.component.html',
  styleUrls: ['./assess-qbank.component.scss']
})
export class AssessQbankComponent implements OnInit{
  ...
  qBankParams = new assessmentQBankParams();
  totalMark: number=0;
  ...
  setExistingItems(items: IAssessmentQBankItem[]) {

    items.forEach(item => {
      this.assessmentQBankItems.push(this.fb.group({
        id: item.id,
