...
@Component({
  selector: 'app-stdd-q-edit',
  templateUrl: './stdd-q-edit.component.html',
  styleUrls: ['./stdd-q-edit.component.scss']
})
export class StddQEditComponent implements OnInit{
  ...
  createForm() {
    this.form = this.fb.group({
      ...
      id: 0, 
      assessmentParameter: ['', [Validators.required, Validators.maxLength(150)]],
