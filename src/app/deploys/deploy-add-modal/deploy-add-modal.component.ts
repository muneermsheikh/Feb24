...
import { IDeployment } from 'src/app/shared/models/process/deployment';
import { DeployService } from 'src/app/shared/services/deploy.service';

@Component({
  selector: 'app-deploy-add-modal',
  templateUrl: './deploy-add-modal.component.html',
  styleUrls: ['./deploy-add-modal.component.scss']
})
export class DeployAddModalComponent implements OnInit {
  ...
  setExistingItems(items: IDeployDto[]) {
